...
main() {
  group("[SpyObject]", () {
    test("records all the calls", () {
      ...
      expect(
          obj.spy("someFunc").mostRecentCall.positionalArguments, equals([3]));
      expect(obj.spy("someFunc").mostRecentCall.namedArguments,
          equals({"named": "named"}));
    });
    ...
    test("handles setters", () {
      ...
      expect(obj.spy("set:someFunc").mostRecentCall.positionalArguments,
          equals([10]));
    });
  ...
  group("[SpyFunction]", () {
    ...
    test("records named arguments", () {
      ...
      expect(
          s.mostRecentCall.namedArguments, equals({"named1": 1, "named2": 2}));
    });
